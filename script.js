...
window.translations = {
  ...
  ja: {
    ...
    "map-subtitle": "写真をアップロードするか、応援メッセージを残してください！",
  ...
  ko: {
    ...
    "map-subtitle": "사진을 업로드하거나 응원 메시지를 남겨주세요!",
  ...
  es: {
    ...
    "map-title": "Mapa Interactivo Global de Pinktiger 🗺️",
    "map-subtitle": "¡Sube una foto o deja un mensaje de apoyo!",
