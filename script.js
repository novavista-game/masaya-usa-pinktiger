...
window.translations = {
  ...
  ja: {
    ...
    "footer-disclaimer": "注意事項：当サイトのすべての権利はMasayaUSAPinktigerに帰属し、堀川マサヤ氏およびその所属事務所とは一切関係がありません。当サイトはファンが運営する非営利サイトです。",
  ...
  ko: {
    ...
    "footer-disclaimer": "주의사항: 본 사이트의 모든 권리는 MasayaUSAPinktiger에 있으며, 호리카와 마사야 님이나 그의 소속사와는 아무런 관계가 없음을 공지합니다. 본 사이트는 팬들이 운영하는 비영리 사이트입니다.",
  ...
  es: {
    ...
    "footer-disclaimer": "Aviso: Todos los derechos de este sitio pertenecen a MasayaUSAPinktiger. No tenemos ninguna relación ni afiliación con Masaya Horikawa ni con su agencia. Este es un sitio web sin fines de lucro administrado por fans.",
