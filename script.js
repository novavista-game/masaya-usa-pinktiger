...
window.translations = {
  ...
  es: {
    ...
    "footer-disclaimer": "Descargo de responsabilidad: Todos los derechos pertenecen a Masaya Horikawa. Este sitio es completamente dirigido por fans y sin fines de lucro.",
